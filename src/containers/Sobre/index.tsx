...
const Sobre = () => (
  <section>
    ...
    <Paragrafo tipo="principal">
      ...
      perferendis quisquam distinctio consectetur assumenda voluptatum dolore
      dolor quibusdam voluptate, voluptatibus aliquam libero ullam? Sapiente
      odio doloremque et nobis adipisci!
    </Paragrafo>
    <GithubSecao>
